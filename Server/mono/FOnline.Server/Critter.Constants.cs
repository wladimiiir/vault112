...
namespace FOnline
{
	public static class Stats
	{
		...
		public const uint IntellectExt = 36;
		// for backward compatibility
		...
		public const uint PoisonResistanceExt = 63;
		// Used in engine ---
		...
		public const uint Age = 70;
		// Used in engine
		public const uint Gender = 71;
		// Used in engine
		public const uint CurrentHP = 72;
		// Used in engine    
		public const uint PoisoningLevel = 73;
		// Used in engine
		public const uint RadiationLevel = 74;
		// Used in engine
		public const uint CurrentAP = 75;
		// Used in engine
		public const uint Experience = 76;
		// Used in engine
		public const uint Level = 77;
		// Used in engine
		public const uint UnspentSkillPoints = 78;
		// Used in engine
		public const uint UnspentPerks = 79;
		// Used in engine
		public const uint Karma = 80;
		// Used in engine
		public const uint FollowCrit = 81;
		// Used in engine
		public const uint ReplicationMoney = 82;
		// Used in engine
		public const uint ReplicationCount = 83;
		// Used in engine
		public const uint ReplicationTime = 84;
		// Used in engine
		public const uint ReplicationCost = 85;
		// Used in engine
		public const uint TurnBasedAC = 86;
		// Used in engine
		public const uint MaxMoveAP = 87;
		// Used in engine
		public const uint MoveAP = 88;
		// Used in engine
		public const uint NpcRole = 89;
		// Used in engine
		...
		public const uint BonusLook = 101;
		// Used in engine
		public const uint HandsItemAndMode = 102;
		// Used in engine
		public const uint FreeBarterPlayer = 103;
		// Used in engine
		public const uint DialogId = 104;
		// Used in engine
		public const uint AiId = 105;
		// Used in engine
		public const uint TeamId = 106;
		// Used in engine
		public const uint BagId = 107;
		// Used in engine
		public const uint LastStealCrId = 108;
		public const uint StealCount = 109;
		public const uint LastWeaponId = 110;
		// Used in engine
		public const uint LastWeaponUse = 111;
		public const uint BaseCrType = 112;
		// Used in engine
		public const uint DeadBlockerId = 113;
		public const uint CurrentArmorPerk = 114;
		public const uint TalkDistance = 115;
		// Used in engine; if zero then Global.TalkDistance is used
		public const uint ScaleFactor = 116;
		// Used in engine
		public const uint WalkTime = 117;
		// Hardcoded
		public const uint RunTime = 118;
		// Hardcoded
		public const uint MaxTalkers = 119;
		// Hardcoded
		...
		public const uint BonusLookExt = 134;
		// 133..149
		//#ifdef PLAYERS_3D
	...
	public static class Perks
	{
		...
		public const uint BOOKWORM = 300;
		// Todo
		...
		public const uint NIGHT_VISION = 310;
		// Todo
		public const uint PRESENCE = 311;
		// Todo
		...
		public const uint SILENT_RUNNING = 316;
		// Hardcoded
		public const uint SURVIVALIST = 317;
		public const uint MASTER_TRADER = 318;
		// Hardcoded
		...
		public const uint MENTAL_BLOCK = 328;
		// Todo
		...
		public const uint FRIENDLY_FOE = 337;
		// Todo
		public const uint PICKPOCKET = 338;
		public const uint GHOST = 339;
		public const uint CULT_OF_PERSONALITY = 340;
		// Todo
		public const uint SCROUNGER = 341;
		// Todo
		public const uint EXPLORER = 342;
		public const uint FLOWER_CHILD = 343;
		// Todo
		public const uint PATHFINDER = 344;
		public const uint ANIMAL_FRIEND = 345;
		// Todo
		public const uint SCOUT = 346;
		public const uint MYSTERIOUS_STRANGER = 347;
		// Todo
		public const uint RANGER = 348;
		public const uint QUICK_POCKETS = 349;
		// Hardcoded
		public const uint SMOOTH_TALKER = 350;
		// Hardcoded
		public const uint SWIFT_LEARNER = 351;
		public const uint TAG = 352;
		// Todo
		public const uint MUTATE = 353;
		// Todo
		// 354..379
	...
	{
		public const uint Poisoned = 500;
		// Used in engine
		public const uint Radiated = 501;
		// Used in engine
		public const uint Eye = 502;
		// Used in engine
		public const uint RightArm = 503;
		// Used in engine
		public const uint LeftArm = 504;
		// Used in engine
		public const uint RightLeg = 505;
		// Used in engine
		public const uint LeftLeg = 506;
		// Used in engine
	}
	
	public static class Modes
	{
		public const uint Hide = 510;
		// Состояние скрытности                                   Hardcoded
		public const uint NoSteal = 511;
		// Нельзя обворовать                                      Hardcoded
		public const uint NoBarter = 512;
		// Нельзя тоговать                                        Hardcoded
		public const uint NoEnemyStack = 513;
		// Нпц не запоминает врагов                               Hardcoded
		public const uint NoPVP = 514;
		// Запрещает ПвП для игрока                               Hardcoded
		public const uint EndCombat = 515;
		// Согласен ли игрок закончить пошаговый бой              Hardcoded
		public const uint DefaultCombat = 516;
		// Режим боя по-умолчанию                                 Hardcoded
		public const uint NoHome = 517;
		// Нпц не возвращается в домашнюю позицию автоматически   Hardcoded
		public const uint GECK = 518;
		// Локация не удаляется при наличии такого нпц            Hardcoded
		public const uint NoFavoriteItem = 519;
		// Режим установки итемов по-умолчанию                    Hardcoded
		public const uint NoItemGarbager = 520;
		// Итемы не удаляются движком                             Hardcoded
		public const uint DlgScriptBarter = 521;
		// Возможно торговать при активном скрипте на диалоге     Hardcoded
		public const uint UnlimitedAmmo = 522;
		// Бесконечные патроны                                    Hardcoded
		public const uint NoDrop = 523;
		// Нельзя сбрасывать предметы
		public const uint NoLooseLimbs = 524;
		// Не может терять конечности
		public const uint DeadAges = 525;
		// Мёртвое тело не исчезает
		public const uint NoHeal = 526;
		// Повреждения не излечиваются с течением времени
		public const uint Invulnerable = 527;
		// Неуязвимый                                             Hardcoded
		public const uint NoFlatten = 528;
		// Не помещать труп на задний план после смерти           Hardcoded
		public const uint SpecialDead = 529;
		// Есть особый вид смерти
		public const uint RangeHtH = 530;
		// Возможна рукопашная атака на расстоянии                Hardcoded
		public const uint NoKnock = 531;
		// Не может быть сбит с ног
		public const uint NoLoot = 532;
		// Нельзя лутать                                          Hardcoded
		//public const uint NoSupply = 533; // Не приходят охотники за головами при смерти нпц
		public const uint Ext = 534;
		public const uint BarterOnlyCash = 535;
		// При бартере нпц принимает оплату только наличными
		public const uint NoPush = 536;
		// Can't be pushed                                        Hardcoded
		public const uint NoUnarmed = 537;
		// Not have unarmed attacks                               Hardcoded
		public const uint NoAim = 538;
		// Critter can't do aim attacks                           Hardcoded
		public const uint NoWalk = 539;
		// Critter can't walk                                     Hardcoded
		public const uint NoRun = 540;
		// Critter can't run                                      Hardcoded
		public const uint NoTalk = 541;
		// Npc can't talk                                         Hardcoded
		//Vault 112 modes
		public const uint VisibilityFlags = 836;
	...
	{
		NoSlave = 0x00000001,
		NoWallCheck = 0x00000002,
		// applies only when sneaking, used in dll
		Mob = 0x00000004,
		Guard = 0x00000008,
		Trader = 0x00000010,
		Follower = 0x00000020,
		...
		NoDeterioration = 0x00000200,
		// used in dll
		Event = 0x00000400,
		// Part of event
		NoAttackAuth = 0x00000800,
		// Don't attack authenticated players
		Militia = 0x00001000,
		// TC Militia
		TCLeader = 0x00002000,
		// TC Leader
		Slave = 0x00004000,
		// to diferentiate slaves within other followers
		LookAdmin = 0x00008000,
		// used in dll
		LookInvisible = 0x00010000
		// used in dll
	}
