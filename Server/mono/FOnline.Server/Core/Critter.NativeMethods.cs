...
namespace FOnline
{
	public partial class Critter
	{
		...
		public virtual bool IsAnim1 (uint index)
		{
			return Crit_IsAnim1 (thisptr, index);
		}
		public virtual AccessType GetAccess ()
		{
			return (AccessType)Cl_GetAccess (thisptr);
		} // maybe move to derived Client class?
